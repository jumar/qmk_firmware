...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_0_QWERTY] = LAYOUT_ortho_5x15(
        KC_ESC     , KC_MYCM    , XXXXXXX, KC_GRV       , XXXXXXX    , XXXXXXX, XXXXXXX , TG(5), KC_PSCR, XXXXXXX   , KC_LEFT, KC_UP  , KC_DOWN, KC_RGHT, KC_BSPC,
        ...
        KC_ENT     , HYPR(KC_NO), MEH(KC_NO), KC_LGUI   , KC_LALT    , KC_SPC , KC_BSPC , TG(1), KC_DEL , LT3_ENT   , LT1_DEL, LT4_GRV , XXXXXXX, XXXXXXX, XXXXXXX
    ),
	...
	[_4_GAMING] = LAYOUT_ortho_5x15(
        ...
        KC_LCTL, _______, KC_LGUI, _______, KC_LALT, KC_SPC , KC_BSPC, XXXXXXX, KC_DEL , KC_ENT , _______, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
    ),
	[_5_GRAVE_RGB] = LAYOUT_ortho_5x15(
        RESET  , DEBUG  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX , XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, KC_GRV , XXXXXXX, XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_VAI, XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_VAD, XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_MOD, RGB_RMOD, RGB_LYR, XXXXXXX, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    )
};
